...
export default function GenerateHubPage() {
  ...
  const [pbjData, setPbjData] = useState<any>({
    ...
    tempat_ba: "Balai Desa Sidaurip", perwakilan_bpd: "", tanggal_paktaintegritas_tpk: "",
  ...
  const [spjData, setSpjData] = useState<any>({
    ...
    ba_hps_time: "09:00",
    ba_hps_location: "Balai Desa Sidaurip",
    ba_hps_leader_name: "",
  ...
  useEffect(() => {
    if (activity) {
      ...
      setSpjData((prev: any) => ({ 
        ...
        ba_hps_location: activity.ba_hps_location || "Balai Desa Sidaurip",
