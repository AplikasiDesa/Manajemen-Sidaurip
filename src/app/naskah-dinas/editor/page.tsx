...
function EditorContent() {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      if (initialData.tempat === "Balai Desa Sidaurip") setLocationType("balai")
       ...
       <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 p-1 bg-slate-50 rounded-xl">
              <Button 
                ...
                onClick={() => {
                  ...
                  updateField("tempat", "Balai Desa Sidaurip");
                }}
              >
                Balai Desa
              </Button>
          ...
          {locationType === 'manual' && (
            <Input 
              ...
              value={formData.tempat === "Balai Desa Sidaurip" ? "" : formData.tempat} 
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
                ...
                <Input placeholder="Balai Desa Sidaurip" value={formData.tempat || ""} onChange={e => updateField("tempat", e.target.value)} className="h-12 rounded-xl" />
            </div>
        </div>
        <div className="space-y-2">
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
            <div className="space-y-2">
                ...
                <Textarea placeholder="Peraturan Desa Nomor 08 Tahun 2025..." value={formData.dasar || ""} onChange={e => updateField("dasar", e.target.value)} className="rounded-xl" />
            </div>
            <div className="space-y-4">
                <div className="flex items-center justify-between">
