...
export const generateAttendancePDF = async (report: AttendanceReportData): Promise<Blob> => {
  ...
  const addLandscapeKop = () => {
    ...
    doc.text("Jl. Perintis No.144, Desa Sidaurip, Kec. Gandrungmangu, Kab. Cilacap, Jawa Tengah", pageWidth / 2, 29, { align: "center" });
    doc.text("Tlp. 0851-3221-7144, Laman :  www.sidaurip.gandrungmangu.id, Pos-el : sidaurip818@gmail.com", pageWidth / 2, 33, { align: "center" });
